    ...
    >
      <div className="rounded-[11px] bg-card p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-emerald-dim/30 px-2 py-0.5 text-[10px] font-semibold text-accent">
            <TrendingUp className="h-3 w-3" /> +18%
          </span>
        </div>
        <p className="text-3xl font-bold gold-text tracking-tight">
