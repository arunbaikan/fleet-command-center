...
const LoanApplication = () => {
  ...
  const autoFillUserDetails = async () => {
    try {
      setPageLoading(true);
      const mobile = sessionStorage.getItem("mobile_number") || "9876543210";
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC]">
        <div className="flex flex-col items-center justify-center gap-8 w-full max-w-md px-6">
          ...
          <div className="w-full h-5 bg-white border-2 border-slate-200 rounded-full p-1 shadow-sm">
            <div className="h-full bg-gradient-to-r from-[#7c3aed] to-[#a855f7] rounded-full animate-pulse" style={{ width: '60%' }} />
          </div>
        </div>
      </div>
    );
                ...
                <div className="space-y-6 mt-8 pt-6 border-t border-border">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                    <div className="md:col-span-2 space-y-2">
                      ...
                      <textarea value={formData.addressLine1} onChange={(e) => updateFormData("addressLine1", e.target.value)} className={cn("w-full rounded-md bg-background px-3 py-2 text-sm border border-input focus:ring-primary", errors.addressLine1 && "border-destructive")} rows={3} />
            ...
            <FormCard title="Review & Edit Employment and Credit Details" subtitle="Please review and update your employment and credit information">
              ...
              <div className="space-y-6 mt-8 pt-6 border-t border-border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <FormSelect label="Residential Stability" value={formData.residentialStability} onChange={(v) => updateFormData("residentialStability", v)} options={[{ value: "1", label: "Less than 1 year" }, { value: "3", label: "1-3 years" }, { value: "5", label: "3-5 years" }, { value: "10", label: "More than 5 years" }]} required error={errors.residentialStability} />
