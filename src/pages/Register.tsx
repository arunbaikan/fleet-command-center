    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 py-10">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl purple-gradient shadow-lg mb-3">
            <Skull className="h-7 w-7 text-primary-foreground" />
          </div>
          <h1 className="text-xl font-bold text-foreground">
            Happirate <span className="purple-text">Fleet</span>
          </h1>
          <p className="text-xs text-muted-foreground mt-0.5">New Partner Registration</p>
        </div>
        ...
        <div className="card-elevated rounded-2xl p-6 shadow-xl">
          ...
          <AnimatePresence mode="wait">
            ...
            {/* ── STEP: Mobile ─────────────────────────── */}
            {step === "mobile" && (
              <motion.div key="mobile" initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 16 }} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  {mobileError && <p className="text-[11px] text-destructive font-medium">{mobileError}</p>}
                </div>

                <button
                  onClick={handleSendOtp} disabled={loading || mobile.length !== 10}
                  className="w-full flex items-center justify-center gap-2 rounded-xl h-11 text-sm font-semibold purple-gradient text-primary-foreground shadow hover:opacity-90 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
              ...
              <motion.div key="otp" initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }} className="space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Sent to +91 {mobile.slice(0,5)}*****</p>
                  </div>
                </div>
                ...
                <button onClick={() => setStep("mobile")} className="w-full text-xs text-muted-foreground hover:text-foreground flex items-center justify-center gap-1 transition-colors">
            ...
            {/* ── STEP: Personal ───────────────────────── */}
            {step === "personal" && (
              <motion.div key="personal" initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }} className="space-y-4">
            ...
            {/* ── STEP: Business ───────────────────────── */}
            {step === "business" && (
              <motion.div key="business" initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }} className="space-y-4">
                <div className="flex items-center gap-3 mb-1">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary/10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Help lenders know your business</p>
                  </div>
                </div>
            ...
            {/* ── STEP: KYC ────────────────────────────── */}
            {step === "kyc" && (
              <motion.div key="kyc" initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }} className="space-y-4">
                <div className="flex items-center gap-3 mb-1">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary/10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Required for commission payouts</p>
                  </div>
                </div>
            ...
            {/* ── STEP: Success ─────────────────────────── */}
            {step === "success" && (
              <motion.div key="success" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center space-y-5 py-4">
                <motion.div
                  initial={{ scale: 0 }} animate={{ scale: 1 }}
                  transition={{ type: "spring", stiffness: 200, delay: 0.1 }}
                  className="flex h-20 w-20 items-center justify-center rounded-full purple-gradient shadow-lg mx-auto"
                >
                ...
                <button onClick={handleGoToDashboard}
                  className="w-full flex items-center justify-center gap-2 rounded-xl h-11 text-sm font-semibold purple-gradient text-primary-foreground shadow hover:opacity-90 active:scale-95 transition-all"
                >
